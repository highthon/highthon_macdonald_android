...
class ETCAdapter(
...
) : RecyclerView.Adapter<ETCAdapter.ETCDataViewHolder>() {

    inner class ETCDataViewHolder(val itemQuestionBinding: ItemQuestionBinding) :
        RecyclerView.ViewHolder(itemQuestionBinding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ETCDataViewHolder(
    ...
    override fun onBindViewHolder(holder: ETCDataViewHolder, position: Int) {
